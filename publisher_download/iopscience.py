...
def download(resolved_url: str, html_content: str, doi: str, *, task_name: str = "", item_index: int = 1, project_root: str | Path | None = None) -> dict[str, str | bool]:
    return download_by_template_map(resolved_url, html_content, doi, task_name=task_name, item_index=item_index, project_root=project_root, host_to_template=HOST_TO_PAPER_URLS, logger=logger, site_name="iopscience")
